...
<div class="background1">
	...
	<div class="button" id="menuebutton"></div>
        <div><img class="middle" src="pictures/meetup_logo.png" alt="link" width="80" height="70" /></div>
        <br>
		<hr>

	<ul>
		<p><img src="pictures/home.png" height="40" width="40" hspace="1" vspace="1" alt="home">Home</p>
		<p><img src="pictures/task.png" height="40" width="40" hspace="1" vspace="1"  alt="task">My Task</p>
		<p><img src="pictures/inbox.png" height="40" width="40" hspace="1" vspace="1" alt="inbox"><a href="javascript:inbox()">Inbox</a></p>
		<p><img src="pictures/person.png" height="40" width="40" hspace="1" vspace="1"  alt="person">Profile</p>
	...
	<div id="Abbruch"><img src="pictures/baseline_close_black_18dp.png"></div><br>
		<div id="punkte">
</div>
	</dialog>
	</main>
	...
	<nav>
		...
		<ul>
			 <li><button id="start"><img src="pictures/navigation.png" height="50" width="50" align="left" alt="navigation"></button></a></li>
		...
		<ul>
			<li><a class="add" onclick="document.getElementById('l_add').style.display='block'"
		...
		<div class="notifi-box" id="box">
			...
			<div class="notifi-item">
				...
				<div class="text">
				   ...
				   <p>Sie müssten mir die Unterlagen vom 28.02.2021 noch bitte zusenden.</p>
			    </div> 
			</div>
			...
			<div class="notifi-item">
				...
				<div class="text">
				   ...
				   <p>Ich möchte Sie nochmals an das Meeting am 27.02.2021 erinnern.</p>
			    </div> 
			</div>
...
<div class="popup" onclick="myFunction()"><img src="pictures/mannschaft.png" alt="">
  <span class="popuptext" id="myPopup"><h4>Marketing-Team</h4>
  <hr>
  <br>
  <div class="chip">
