...
<body>
	...
	<div class="background2">
		<br>
		<div class="editHeader">Edit Note</div>
		<hr>
		<br>
		<div class="editBody">
			<%
			...
			<form action="UpdateNote" method="post">
				...
				<div>
					<label>Title</label><input type="text" name="noteTitle"
						value='<%=rs.getString("noteTitle")%>' />
				</div>
				<div>
					<label style="margin-left: -105px">Date</label><input
						type="date" name="date"
						value='<%=rs.getDate("date").toLocalDate()%>' />
				</div>
