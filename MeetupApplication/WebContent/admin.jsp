...
<body>
	<div class="background1">
		<div class="headliner_block">
			...
			<div class="firstBox">
				<h3>
					Welcome <a class="firstname"><%=request.getAttribute("email")%></a><br>
					<a><%=request.getAttribute("firstName")%></a>
				</h3>
				<a class="favorites"
	...
	<div class="background2">
			...
			<div class="popupBlock">
				...
				<div class="popupBody">
					...
					<div class="popupInfo">
						...
						<form name="form1" method="post" action="imageProcess.jsp"
							enctype="multipart/form-data">
							<div>
								<label>Name</label> <input type="text" name="fname" size="50" />
							</div>
							<div>
		...
		<br> <br>
		<div class="logout">
			<a href="<%=request.getContextPath()%>/LogoutController"><img
				src="pictures/logout.png" alt="Logout" />Logout</a>
		</div>
	</div>
</body>
</html>