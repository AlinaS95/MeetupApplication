	...
	<div class="background1">
		...
		<div class="mainmenu">
			...
			<ul class="navMenu">
				...
				<li><a href="progress.jsp?wID=${login.WID}" style="text-decoration:none">Tasks I created</a></li>
				<li><a href="list.jsp?wID=${login.WID}" style="text-decoration:none">Tasks I assigned to others</a></li>
				<li><a href="progress.jsp?wID=${login.WID}" style="text-decoration:none">Recently completed Tasks</a></li>
				<br>
				<hr>
				<p>Team:</p>
				<%
	...
	<div class="background2">
		...
		<div class="editBody">
			...
			<form action="UpdatePost" method="post">
				...
				<div>
					<label style="margin-left: -133px">Status</label> <select
						name="status"><%=rs.getString("status")%>
				...
				<br> <br> <br> <a class="aButtons"
					href="socialmedia.jsp?wID=${login.WID}">Back</a>
